Function UpdateBreachEvents()
	...
	For e.Events = Each Events
		If e\EventConst <> e_breach Then
			e\NearObject = FindEventObject(e)
			e\dist = CalculateDist(e\NearObject, e\room)
		EndIf
		Select e\EventConst
			;[Block]
			Case e_room012
				If PlayerInRoom(e) Then
					If Not Player[e\NearObjectQueue]\IsDead Then
						If e\EventState=0 Then
							If EntityDistance(e\NearObject, e\room\RoomDoors[0]\obj)<2.5 And RemoteDoorOn Then
						...
						Else
							...
							If Wearing714=False And WearingGasMask<3 And WearingHazmat<3 Then
								...
								;DebugLog "WHERE IS IT?!"	
									...
									RotateEntity(e\NearObject, EntityPitch(e\NearObject), CurveAngle(EntityYaw(pvt), EntityYaw(e\NearObject), 80-(e\EventState3/200.0)), 0)
									...
									dist = Distance(EntityX(e\NearObject),EntityZ(e\NearObject),EntityX(e\room\Objects[2],True),EntityZ(e\room\Objects[2],True))
									...
									If dist < 0.6 Then
										...
										If e\EventState3>70 And e\EventState3-FPSfactor=<70 Then
											...
											multiplayer_WriteTempSound("SFX\SCP\012\Speech1.ogg")
										ElseIf e\EventState3>13*70 And e\EventState3-FPSfactor=<13*70
											...
											multiplayer_WriteTempSound("SFX\SCP\012\Speech2.ogg")
										ElseIf e\EventState3>31*70 And e\EventState3-FPSfactor=<31*70
											...
											multiplayer_WriteTempSound("SFX\SCP\012\Speech"+Rand(3,4)+".ogg")
										ElseIf e\EventState3>49*70 And e\EventState3-FPSfactor=<49*70
											...
											multiplayer_WriteTempSound("SFX\SCP\012\Speech5.ogg")
										ElseIf e\EventState3>63*70 And e\EventState3-FPSfactor=<63*70
											...
											multiplayer_WriteTempSound("SFX\SCP\012\Speech6.ogg")
										ElseIf e\EventState3>74*70 And e\EventState3-FPSfactor=<74*70
											...
											Crouch = True
											multiplayer_WriteTempSound("SFX\SCP\012\Speech7.ogg")
											de.Decals = CreateDecal(17,  EntityX(e\NearObject), -768*RoomScale+0.01, EntityZ(e\NearObject),90,Rnd(360),0)
										...
										ElseIf e\EventState3>85*70 And e\EventState3-FPSfactor=<85*70	
											...
											Kill("was killed by SCP-012")
										EndIf
										
										RotateEntity(e\NearObject, EntityPitch(e\NearObject), CurveAngle(EntityYaw(e\NearObject)+Sin(e\EventState3*(e\EventState3/2000))*(e\EventState3/300), EntityYaw(e\NearObject), 80), 0)
										
									Else
										angle = WrapAngle(EntityYaw(pvt)-EntityYaw(e\NearObject))
										If angle<40.0 Then
								...
								;	If EntityY(e\NearObject)=-768.0*RoomScale Then
									If (Distance(EntityX(e\NearObject), EntityZ(e\NearObject), EntityX(e\room\RoomDoors[0]\frameobj), EntityZ(e\room\RoomDoors[0]\frameobj))<4.5) And  EntityY(e\NearObject)<-2.5 Then
										pvt% = CreatePivot()
										PositionEntity pvt, EntityX(Camera), EntityY(e\NearObject), EntityZ(Camera)
										PointEntity(pvt, e\room\RoomDoors[0]\frameobj)
										;TurnEntity(pvt, 90, 0, 0)
										user_camera_pitch = CurveAngle(90, user_camera_pitch+90, 100)
										user_camera_pitch=user_camera_pitch-90
										RotateEntity(e\NearObject, EntityPitch(e\NearObject), CurveAngle(EntityYaw(pvt), EntityYaw(e\NearObject), 150), 0)
				...
				EndIf
			Case e_room106
				;if PlayerInRoom(e) Then e\room\RoomDoors[0]\liftstate = UpdateElevators(e\room\RoomDoors[0]\liftstate, e\room\RoomDoors[0], e\room\RoomDoors[1], e\room\Objects[9], e\room\Objects[10])
			Case e_room2tunnel
				;[Block]
				If EntityY(Collider,True)>=8.0 And EntityY(Collider,True)<=12.0 Then
					...
					EndIf
				EndIf
				If (PlayerInRoom(e) And NetworkServer\MainPlayer) Or PlayerRoom = e\room Then
					;[Block]
					Local Meshes%[7]
					Local tempStr$
					...
					If EntityY(e\NearObject,True)>4.0 Then
						If EntityY(Collider, True) > 4.0 Then If PlayerRoom = e\room Then ShouldPlay = 7
						
						If e\EventState = 0 Then
							If EntityDistance(e\NearObject, e\room\Objects[0]) < EntityDistance(e\NearObject, e\room\Objects[1]) Then
								temp = 0
							Else
								temp = 1
							EndIf
					...
					e\room\RoomDoors[0]\liftstate = UpdateElevators(e\room\RoomDoors[0]\liftstate, e\room\RoomDoors[0], e\room\RoomDoors[1],e\room\Objects[2],e\room\Objects[3],False)
					e\room\RoomDoors[2]\liftstate = UpdateElevators(e\room\RoomDoors[2]\liftstate, e\room\RoomDoors[2], e\room\RoomDoors[3],e\room\Objects[4],e\room\Objects[5],False)
					
					ShowRoomDoorOriginal(e\room\RoomDoors[0])
					ShowRoomDoorOriginal(e\room\RoomDoors[1])
					ShowRoomDoorOriginal(e\room\RoomDoors[2])
					ShowRoomDoorOriginal(e\room\RoomDoors[3])
				Else
					If e\room\grid <> Null
			...
			Case e_checkpoint
				...
				EndIf
				e\room\RoomDoors[0]\timerstate = 500
				e\room\RoomDoors[1]\timerstate = 500
				If e\room\RoomDoors[0]\open <> e\EventState Then
					If e\Sound = 0 Then LoadEventSound(e,"SFX\Door\DoorCheckpoint.ogg")
					If Not ChannelPlaying(e\SoundCHN) Then e\SoundCHN = PlaySound2(e\Sound,Camera,e\room\RoomDoors[0]\obj)
					If Not ChannelPlaying(e\SoundCHN2) Then e\SoundCHN2 = PlaySound2(e\Sound,Camera,e\room\RoomDoors[1]\obj)
				EndIf
			...
			Case e_room049
				;[Block]
				If PlayerInRoom(e) Then
					If EntityY(e\NearObject) <= -2848*RoomScale Then
						...
						If x Then
							If PlayerRoom = e\room Then ShouldPlay = 8
					...
					EndIf
				EndIf
				e\room\RoomDoors[0]\liftstate = UpdateElevators(e\room\RoomDoors[0]\liftstate, e\room\RoomDoors[0], e\room\RoomDoors[1],e\room\Objects[0],e\room\Objects[1], True)
				e\room\RoomDoors[2]\liftstate = UpdateElevators(e\room\RoomDoors[2]\liftstate, e\room\RoomDoors[2], e\room\RoomDoors[3],e\room\Objects[2],e\room\Objects[3], True)
			Case e_breach
			...
			Case e_room860
				...
				If fr<>Null Then
					...
					If NetworkServer\MainPlayer Then UpdateForest(fr,e\NearObject, True)

					inforest = UpdateForest(fr,Collider)
				EndIf
				
				If inforest Then
					If PlayerRoom\RoomTemplate\Name <> "dimension1499" And PlayerRoom\RoomTemplate\Name <> "pocketdimension" Then
				...
				If (PlayerRoom = e\room And fr<>Null) Then 
					...
					If e\EventState=1.0 Then ;the player is in the forest
						...
						If (Not NoClip)
							If EntityY(Collider)> EntityY(fr\Forest_Pivot,True)+0.5
								...
								If EntityInView(fr\Door[i], Camera) Then
									...
									If MouseHit1 Then
										...
										Else
											...
											multiplayer_WriteTempSound "SFX\Door\WoodenDoorBudge.ogg"
					...
					Else
						...
						If EntityYaw(e\room\Objects[3])=0.0 Then
							...
							If (Abs(Distance(EntityX(e\room\Objects[3],True),EntityZ(e\room\Objects[3],True),EntityX(Collider,True),EntityZ(Collider,True)))<1.0) Then
								...
								If MouseHit1 Then
									PlaySound_Strict(LoadTempSound("SFX\Door\WoodenDoorOpen.ogg"))
									multiplayer_WriteTempSound "SFX\Door\WoodenDoorOpen.ogg"
									ShowEntity fr.Forest\Forest_Pivot
									SelectedItem = Null
				...
				Else
					If (fr<>Null) Then
						If (fr\Forest_Pivot<>0) And (Not PlayerInRoom(e)) Then
			...
			Case e_pocketdimension
				...
				If PlayerRoom=e\room Then
					...
					If (EntityY(e\NearObject)<2000*RoomScale Or EntityY(e\NearObject)>2608*RoomScale) Then CurrStepSFX = 1
					...
					If EntityY(e\NearObject)<2000*RoomScale Or e\EventState3=0 Or EntityY(e\NearObject)>2608*RoomScale Then 
						ShouldPlay = 3
					Else 
						ShouldPlay = 0
					EndIf
					...
					If e\EventState2 = 1 Then ;in the second room
						...
						If e\room\ObjectStatic[9] = True Then
						...
						If e\EventState3 = 1 Or e\EventState3 = 2 Then ;the "trick room"
							...
							If EntityY(e\NearObject)<5.0 Then e\EventState3 = 0
						Else
							;the trenches
							If EntityY(e\NearObject)>6.0 Then
								ShouldPlay = 15
								...
								If EntityX(e\room\Objects[20],True)<EntityX(e\room\Objects[8],True)-4000*RoomScale Then
									...
									PositionEntity e\room\Objects[20], EntityX(e\NearObject,True)+4000*RoomScale, 12.0, EntityZ(e\NearObject,True)
								EndIf
								
								MoveEntity(e\NearObject, 0, Min((12.0 - EntityY(e\NearObject)),0.0)*FPSfactor, 0)
								
								x = -FPSfactor*RoomScale*4.0
								y = (17.0-Abs(EntityX(e\NearObject)-EntityX(e\room\Objects[20]))*0.5)-EntityY(e\room\Objects[20])
								z = EntityZ(e\NearObject,True)-EntityZ(e\room\Objects[20])
								TranslateEntity e\room\Objects[20], x, y, z,True
								RotateEntity e\room\Objects[20], -90-(EntityX(e\NearObject)-EntityX(e\room\Objects[20]))*1.5, -90.0, 0.0, True
								...
								For i = 0 To 2
									...
									If Distance(EntityX(e\NearObject), EntityZ(e\NearObject), x, z) < 200*RoomScale Then safe = True : Exit
								Next
								
								dist = EntityDistance(e\NearObject, e\room\Objects[20])
								...
								If safe Then
									EntityTexture e\room\Objects[20], e\room\RoomTextures[18]
								ElseIf dist < 8.0
									e\SoundCHN = LoopSound2(e\Sound, e\SoundCHN, Camera, e\room\Objects[20], 8.0)
									EntityTexture e\room\Objects[20], e\room\RoomTextures[19]
									...
									If dist<7.0 Then 
										...
										user_camera_pitch=user_camera_pitch-90
										RotateEntity(e\NearObject, EntityPitch(e\NearObject), CurveAngle(EntityYaw(pvt), EntityYaw(e\NearObject), 10), 0)
										FreeEntity pvt
									EndIf
								EndIf
								...
								If EntityY(e\NearObject)<8.5 And 0 Then
									...
									PositionEntity(e\NearObject, EntityX(e\room\Objects[8],True)-400*RoomScale, -304*RoomScale, EntityZ(e\room\Objects[8],True))
									ResetEntity e\NearObject
							...
							Else
								...
								If Not player_isdead() Then
									For i = 9 To 10
										dist = Distance(EntityX(e\NearObject), EntityZ(e\NearObject),EntityX(e\room\Objects[i],True),EntityZ(e\room\Objects[i],True))
										If dist<6.0 Then 
											If dist<100.0*RoomScale Then
												pvt=CreatePivot()
												PositionEntity pvt, EntityX(e\room\Objects[i],True),EntityY(e\NearObject),EntityZ(e\room\Objects[i],True)
												
												PointEntity pvt, e\NearObject
												RotateEntity pvt, 0, Int(EntityYaw(pvt)/90)*90,0,True
												MoveEntity pvt, 0,0,100*RoomScale
												PositionEntity e\NearObject, EntityX(pvt),EntityY(e\NearObject),EntityZ(pvt)
												
												FreeEntity pvt
												
												If KillTimer = 0 And (Not player_isdead()) Then
													...
													Kill("was killed in pocket dimension", True)
													multiplayer_WriteTempSound "SFX\Room\PocketDimension\Impact.ogg"
												EndIf
											EndIf
								...
								If EntityDistance(pvt, e\NearObject)<5.0 Then 
								...
								PointEntity e\room\Objects[17], e\NearObject
								TurnEntity e\room\Objects[17], 0, 180, 0
								
								temp = EntityDistance(e\NearObject, e\room\Objects[17])
								If temp < 2000*RoomScale Then
									...
									user_camera_pitch=user_camera_pitch-90
									RotateEntity(e\NearObject, EntityPitch(e\NearObject), CurveAngle(EntityYaw(pvt), EntityYaw(e\NearObject), Min(Max(15000.0 / (-Sanity), 15.0), 500.0)), 0)
									FreeEntity pvt
									
									;teleport the player to the trenches
									If Crouch And 0 Then
										BlinkTimer = -10
										PositionEntity e\NearObject, EntityX(e\room\Objects[8],True)-1344*RoomScale,2944*RoomScale,EntityZ(e\room\Objects[8],True)-1184*RoomScale
										ResetEntity e\NearObject
										Crouch = False
										...
										e\EventStr = Float(0)
									EndIf
								ElseIf EntityY(e\NearObject)<-180*RoomScale ;the "exit room"
									temp = Distance(EntityX(e\NearObject),EntityZ(e\NearObject),EntityX(e\room\Objects[8],True)+1024*RoomScale,EntityZ(e\room\Objects[8],True))
									If temp<640*RoomScale
										BlurTimer = (640*RoomScale-temp)*3000
										
										e\SoundCHN2 = LoopSound2(DecaySFX(Rand(1, 3)), e\SoundCHN2, Camera, e\NearObject, 2.0, (640*RoomScale-temp)*Abs(CurrSpeed)*100)
											...
											If 0 Then
												For r.Rooms = Each Rooms
													If r\RoomTemplate\Name = "room2shaft" Then
														...
														TeleportEntity(e\NearObject,EntityX(r\Objects[0],True),0.4,EntityZ(r\Objects[0],True),0.3,True)
						...
						If EntityY(e\NearObject) < -1600*RoomScale Then
							If EntityDistance(e\NearObject, e\room\Objects[8]) > 4750*RoomScale Then
								If 0 Then
									CameraFogColor Camera, 0,0,0
									CameraClsColor Camera, 0,0,0
									...
									BlurTimer = 500
									BlurTimer = 1500
									PositionEntity(e\NearObject, EntityX(e\room\obj,True), 0.4, EntityX(e\room\obj,True))
									For r.Rooms = Each Rooms
										If r\RoomTemplate\Name = "room106" Then
											e\EventState = 0
											e\EventState2 = 0
											
											TeleportEntity(e\NearObject,EntityX(r\Objects[10],True),0.4,EntityZ(r\Objects[10],True),0.3,True)
					...
					ElseIf e\EventState2 = 0
						dist# = EntityDistance(e\NearObject, e\room\obj)	
							...
							If 0 Then
								...
								Select Rand(25)
									Case 1,2,3,4
										...
										pvt = CreatePivot()
										PositionEntity(pvt, EntityX(e\NearObject), EntityY(e\NearObject), EntityZ(e\NearObject))
									...
									Case 5,6,7,8,9,10 
										...
										PositionEntity(e\NearObject, EntityX(e\room\Objects[8],True), 0.5, EntityZ(e\room\Objects[8],True))
										ResetEntity e\NearObject
									Case 11,12 ;middle of the large starting room
										BlurTimer = 500
										PositionEntity e\NearObject,EntityX(e\room\obj), 0.5, EntityZ(e\room\obj)
									...
									Case 16,17,18,19
										...
										For r.Rooms = Each Rooms
											If r\RoomTemplate\Name = "tunnel" Then
												...
												SecondaryLightOn = PrevSecondaryLightOn
												PrevSecondaryLightOn = 0.0
												TeleportEntity(e\NearObject,EntityX(r\obj,True),0.4,EntityZ(r\obj,True),0.3,True)
									...
									Case 20,21,22 ;the tower room
										BlinkTimer = -10
										PositionEntity(e\NearObject, EntityX(e\room\Objects[12],True), 0.6, EntityZ(e\room\Objects[12],True))
										ResetEntity e\NearObject
										e\EventState2 = 15
									Case 23,24,25
										BlurTimer = 1500
										...
										PositionEntity(e\NearObject, EntityX(e\room\Objects[8],True), 2288*RoomScale, EntityZ(e\room\Objects[8],True))
										ResetEntity e\NearObject
								End Select 
					...
					Else ;pillar room
						...
						If ParticleAmount > 0
							If Rand(800)=1 Then 
								...
								p.Particles = CreateParticle(EntityX(e\NearObject)+Cos(angle)*7.5, 0.0, EntityZ(e\NearObject)+Sin(angle)*7.5, 3, 4.0, 0.0, 2500)
								EntityBlend(p\obj, 2)
								;EntityFX(p\obj, 1)
								p\speed = 0.01
								p\SizeChange = 0
						...
						If EntityY(e\NearObject) < -1600*RoomScale Then
							...
							If Distance(EntityX(e\room\Objects[16],True),EntityZ(e\room\Objects[16],True),EntityX(e\NearObject),EntityZ(e\NearObject))<144*RoomScale Then
								If 0 Then
									CameraFogColor Camera, 0,0,0
									CameraClsColor Camera, 0,0,0
									...
									If e\EventState2 < 2 Then
										If SelectedItem<>Null Then
											If SelectedItem\itemtemplate\tempname="25ct" Or SelectedItem\itemtemplate\tempname="coin" Then
												...
												multiplayer_WriteTempSound("SFX\SCP\294\coin_drop.ogg")
												inserted = True
											EndIf
										EndIf
									EndIf
			...
			Case e_room_gw
				...
				If PlayerInRoom(e) Then
					If e\EventState = 0.0
						If EntityDistance(e\room\Objects[0],e\NearObject)<1.4 And e\EventState3 = 0.0
							e\EventState = 1.0
							If brokendoor
							...
							If PlayerRoom = e\room Then PlaySound_Strict(AlarmSFX(4))
						ElseIf EntityDistance(e\room\Objects[0],e\NearObject)>2.4
							e\EventState3 = 0.0
						EndIf
					Else
			...
			Case e_room2ccont
				...
				If PlayerInRoom(e) Then
					...
					If EntityDistance(e\room\Objects[3], Collider) < 1.0 Then
						If e\EventState = 0
			...
			Case e_room2shaft
				...
				If PlayerRoom = e\room Then
					...
					If ClosestButton = e\room\Objects[2] And MouseHit1 Then
						...
						multiplayer_WriteSound(ButtonSFX2)
						MsgTimer = 5*70
						MouseHit1=0
					EndIf
					If PlayerRoom = e\room Then
						If EntityY(Collider) < -512*RoomScale And KillTimer >= 0 And FallTimer >= 0 And (Not player_isdead()) Then
							DeathMSG=""
							PlaySound_Strict LoadTempSound("SFX\Room\PocketDimension\Impact.ogg")
							multiplayer_WriteTempSound "SFX\Room\PocketDimension\Impact.ogg"
							Kill()
			...
			Case e_room2nuke
				;[Block]
				If PlayerInRoom(e) Then
					e\room\RoomDoors[0]\liftstate = UpdateElevators(e\room\RoomDoors[0]\liftstate, e\room\RoomDoors[0], e\room\RoomDoors[1], e\room\Objects[4], e\room\Objects[5], True)
			...
			Case e_room2storage
				...
				If PlayerRoom = e\room Then
					...
					TFormPoint EntityX(e\NearObject),EntityY(e\NearObject),EntityZ(e\NearObject),0,e\room\obj
					...
					If TFormedX()>730 Then
						...
						HideEntity e\NearObject
						PositionEntity e\NearObject, TFormedX(), EntityY(e\NearObject), TFormedZ(), True
						ShowEntity e\NearObject
					...
					If temp = True Then 
						...
						For it.Items = Each Items
							If EntityDistance(it\collider,e\NearObject)<5.0 Then
					...
					Else
						If e\room\NPC[0] <> Null Then
							If EntityDistance(e\NearObject, e\room\NPC[0]\Collider)<3.0 Then
			...
			Case e_coffin, e_coffin106
				...
				If PlayerRoom = e\room Then
					e\NearObject = Collider
					CoffinDistance = EntityDistance(e\NearObject, e\room\Objects[1])
					...
					If WearingNightVision > 0 Then
						...
						If (CoffinDistance < 4.0) And (hasBatteryFor895) And (Not Wearing714) Then
							tempF# = point_direction(EntityX(e\NearObject,True),EntityZ(e\NearObject,True),EntityX(e\room\Objects[1],True),EntityZ(e\room\Objects[1],True))
							tempF2# = EntityYaw(e\NearObject)
							tempF3# = angleDist(tempF+90+Sin(WrapAngle(e\EventState3/10)),tempF2)
							TurnEntity e\NearObject, 0,tempF3/4,0,True
							tempF# = Abs(point_distance(EntityX(e\NearObject,True),EntityZ(e\NearObject,True),EntityX(e\room\Objects[1],True),EntityZ(e\room\Objects[1],True)))
			...
			Case e_room2sl
				...
				If PlayerInRoom(e) Then
					...
					If Abs(EntityY(e\room\RoomDoors[0]\frameobj)-EntityY(Collider))>1.0 And PlayerRoom = e\room Then
						For i = 0 To 14
			...
			Case e_682roar
				...
				e\StaticEvent = False
				If e\EventState = 0 Then
					If PlayerInRoom(e) Then e\EventState = 70 * Rand(300,1000)
			...
			Case e_914
				...
				;GiveAchievement(Achv914)
					...
					If e\EventState2=1 And PlayerRoom = e\room
						ShouldPlay = 22
					EndIf
							...
							If GrabbedEntity <> 0 Then ;avain
								If GrabbedEntity = e\room\Objects[0] Then
									If e\EventState = 0 Then
										...
										If angle < 90 Then
											RotateEntity(e\room\Objects[0], 0, 0, 361.0)
										ElseIf angle < 180
											RotateEntity(e\room\Objects[0], 0, 0, 180)
										EndIf
									End If
								ElseIf GrabbedEntity = e\room\Objects[1]
									If e\EventState = 0 Then
										...
										If angle > 90 Then
											If angle < 180 Then
												RotateEntity(e\room\Objects[1], 0, 0, 90.0)
											ElseIf angle < 270
												RotateEntity(e\room\Objects[1], 0, 0, 270)
											EndIf
										EndIf
					...
					If e\EventState > 0 Then
						...
						If Distance(EntityX(Collider), EntityZ(Collider), EntityX(e\room\Objects[2], True), EntityZ(e\room\Objects[2], True)) < (170.0 * RoomScale) Then
							If setting = "rough" Or setting = "coarse" Then
								If e\EventState > 70 * 2.6 And e\EventState - FPSfactor2 < 70 * 2.6 Then 
									PlaySound_Strict Death914SFX
									multiplayer_WriteSound(Death914SFX,EntityX(Collider),EntityY(Collider),EntityZ(Collider),3.0)
								EndIf
							EndIf
						...
						If e\EventState > (12 * 70) Then
							...
							If Distance(EntityX(Collider), EntityZ(Collider), EntityX(e\room\Objects[2], True), EntityZ(e\room\Objects[2], True)) < (170.0 * RoomScale) And (Not multiplayer_IsASCP(MyPlayer\BreachType)) Then
								BlurTimer = 1000
								PositionEntity(Collider, EntityX(e\room\Objects[3], True), EntityY(e\room\Objects[3], True) + 1.0, EntityZ(e\room\Objects[3], True))
								ResetEntity(Collider)
								multiplayer_Send(M_UPDATE)
								DropSpeed = 0
								Select setting
									Case "rough"
										Kill("was killed in SCP-914")
									Case "coarse"
										Injuries = 4.0
									...
									Case "fine", "very fine"
										If multiplayer_breach_IsA035(MyPlayer\BreachType) Then
											SuperMan = False
											Kill("was killed in SCP-914")
										Else 
											SuperMan = True
			...
			Case e_gatea
				If PlayerRoom = e\room Then
					...
					If e\room\Objects[0] = 0 Then
						...
						RotateEntity e\NearObject,0,EntityYaw(e\NearObject)+(e\room\angle+180),0
					EndIf
					...
					angle = Max(Sin(EntityYaw(e\NearObject)+90),0.0)
					;240,220,200
					...
					;For e2.Events = Each Events
					;	If e2\EventConst = e_gateaentrance Then
					;		e\room\RoomDoors[1]\liftstate = UpdateElevators(e\room\RoomDoors[1]\liftstate, e\room\RoomDoors[1], e2\room\RoomDoors[0], e2\room\Objects[1],e2\room\Objects[0],False)
					;		Exit
					;	EndIf
					;Next
				Else
					If exit1event <> Null Then
						If PlayerRoom <> exit1event\room And e\EventState <> 0 Then
							ShowEntity Fog
			...
			Case e_room2tesla
				...
				If temp And ((EntityY(e\NearObject, True) > EntityY(e\room\obj,True) And (Not Player[e\NearObjectQueue]\IsDead)) Or (EntityY(Collider, True) > EntityY(e\room\obj,True) And (Not player_isdead())) ) And ((EntityY(e\NearObject, True) < 4.0 And (Not Player[e\NearObjectQueue]\IsDead)) Or (EntityY(Collider, True) < 4.0 And (Not player_isdead()))) Then
					...
					If e\EventState = 0 Then
						...
						If e\dist < 8 Then		
							...
							For i = 0 To 2
								If Distance(EntityX(e\NearObject),EntityZ(e\NearObject),EntityX(e\room\Objects[i],True),EntityZ(e\room\Objects[i],True)) < 300.0*RoomScale Then
					...
					Else
						...
						Else
							...
							If e\EventState < 70 Then 
								...
								If KillTimer => 0 Then 
									For i = 0 To 2
										If Distance3(EntityX(Collider),EntityY(Collider),EntityZ(Collider),EntityX(e\room\Objects[i],True),EntityY(e\room\Objects[i], True), EntityZ(e\room\Objects[i],True)) < 250.0*RoomScale And (Not player_isdead()) Then
											ShowEntity Light
											LightFlash = 0.4
											CameraShake = 1.0
											
											MyPlayer\Health = MyPlayer\Health-5*FPSfactor
											
											
											;if MyPlayer\Health < 1 Then
											;	Kill("was killed by tesla", True)
											;Else
											multiplayer_RequestHealthReduce(5*FPSfactor, "was killed by tesla")
											;EndIf
										EndIf
									Next
								EndIf
			...
			Case e_gateaentrance
				...
				If PlayerInRoom(e) Then 
					e\room\RoomDoors[1]\locked=False
					;If (Not AllInLift(e,  e\room\Objects[0])) Then e\room\RoomDoors[0]\MpLift = True Else e\room\RoomDoors[0]\MpLift = False
					If EntityDistance(Collider, e\room\Objects[1])<4.0 Then
						If NetworkServer\MainPlayer Then GateAEvent\room\RoomDoors[1]\locked = True
						PlayerRoom = GateAEvent\room
					EndIf
				EndIf
				
				e\room\RoomDoors[0]\liftstate = UpdateElevators(e\room\RoomDoors[0]\liftstate, e\room\RoomDoors[0], GateAEvent\room\RoomDoors[1], e\room\Objects[0], e\room\Objects[1])
				;[End Block]
			Case e_exit1
				e\StaticEvent = False
				If PlayerRoom = e\room And EntityY(Collider) > 1040.0*RoomScale Then
					If e\room\Objects[23] = 0 Then
						...
						e\room\Objects[23] = LoadMesh_Strict("GFX\map\exit1terrain.b3d", e\room\obj)
						ScaleEntity e\room\Objects[23],RoomScale,RoomScale,RoomScale,True
						RotateEntity e\room\Objects[23],0,e\room\angle,0,True
						PositionEntity(e\room\Objects[23], EntityX(pvt), EntityY(pvt), EntityZ(pvt), True)
					...
					UpdateButton(e\room\Objects[22])
					If ClosestButton = e\room\Objects[22] And MouseHit1 Then udp_ByteStreamWriteChar(M_WANTWARHEADS)
				Else If PlayerRoom <> gateaevent\room And e\EventState <> 0 Then
					If NetworkServer\BreachLight = False Then
						ShowEntity Fog
						AmbientLight Brightness, Brightness, Brightness
						CameraFogRange(Camera, CameraFogNear, CameraFogFar)
						CameraFogMode(Camera, 1)
				...
				e\room\RoomDoors[4]\locked=False
				e\room\RoomDoors[0]\liftstate = UpdateElevators(e\room\RoomDoors[0]\liftstate, e\room\RoomDoors[0], e\room\RoomDoors[1], e\room\Objects[8], e\room\Objects[9], True)
			...
			Case e_room1162
				...
				If PlayerRoom = e\room
					...
					If EntityDistance(e\room\Objects[0],Collider)<0.75 And Pick1162% And (Not multiplayer_IsASCP(MyPlayer\BreachType))
						DrawHandIcon = True
						If MouseHit1 Then GrabbedEntity = e\room\Objects[0]
					EndIf
					...
					If GrabbedEntity <> 0
						...
						If e\EventState3 = 1.0
							...
							For itt.ItemTemplates = Each ItemTemplates
								...
								If (shouldCreateItem) Then
									...
									e\EventState3 = 0.0
									multiplayer_WriteTempSound("SFX\SCP\1162\Exchange"+Rand(0,4)+".ogg", EntityX(Collider), EntityY(Collider), EntityZ(Collider))
						...
						ElseIf e\EventState3 = 2.0
							...
							pvt = CreatePivot()
							PositionEntity pvt, EntityX(e\NearObject),EntityY(e\NearObject)-0.05,EntityZ(e\NearObject)
							TurnEntity pvt, 90, 0, 0
							EntityPick(pvt,0.3)
							...
							For itt.ItemTemplates = Each ItemTemplates
								If IsItemGoodFor1162(itt) And Rand(6)=1
									...
									If Injuries > 15
										...
										LightFlash = 5.0
										Kill("was killed by SCP-1162")
									Else
										PlaySound_Strict LoadTempSound("SFX\SCP\1162\BodyHorrorExchange"+Rand(1,4)+".ogg")
										multiplayer_WriteTempSound("SFX\SCP\1162\BodyHorrorExchange"+Rand(1,4)+".ogg", EntityX(Collider), EntityY(Collider), EntityZ(Collider))
										LightFlash = 5.0
						...
						ElseIf e\EventState3 >= 3.0
							...
							Else
								...
								If Injuries > 15
									...
									DeathMSG = DeathMSG + " interaction with SCP-1162."
									PlaySound_Strict LoadTempSound("SFX\SCP\1162\BodyHorrorExchange"+Rand(1,4)+".ogg")
									multiplayer_WriteTempSound("SFX\SCP\1162\BodyHorrorExchange"+Rand(1,4)+".ogg", EntityX(Collider), EntityY(Collider), EntityZ(Collider),3.0)
									LightFlash = 5.0
									Kill("was killed by SCP-1162")
								Else
									PlaySound_Strict LoadTempSound("SFX\SCP\1162\BodyHorrorExchange"+Rand(1,4)+".ogg")
			...
			Case e_106sinkhole
				;[Block]
				If e\EventState=0 Or (e\de = Null And (Not RemoveDecals)) Then
				...
				ElseIf PlayerRoom = e\room
					...
					EndIf
					dist = Distance(EntityX(e\NearObject),EntityZ(e\NearObject),EntityX(e\room\obj),EntityZ(e\room\obj))
					If dist < 2.0 Then
						CurrStepSFX=1
						...
						If (Not multiplayer_IsASCP(MyPlayer\BreachType)) And (Not player_isdead()) Then
							If dist<0.5 Then
								If e\EventState2 = 0 Then
									...
									multiplayer_WriteTempSound "SFX\Room\SinkholeFall.ogg"
								EndIf
								
								CurrSpeed = CurveValue(0.0, CurrSpeed, Max(dist*50,1.0))
								
								x = CurveValue(EntityX(e\room\obj),EntityX(e\NearObject),10.0)
								y = CurveValue(EntityY(e\room\obj)-e\EventState2,EntityY(e\NearObject),25.0)
								z = CurveValue(EntityZ(e\room\obj),EntityZ(e\NearObject),10.0)
								PositionEntity e\NearObject, x, y, z, True
			...
			Case e_room205
				...
				If PlayerInRoom(e) Then
					If e\EventState=0 Or e\EventStr <> "loaddone" Then
						...
						EndIf
					Else
						If PlayerRoom = e\room Then ShouldPlay = 16
						If (e\EventState<65) Then
							If (Distance(EntityX(e\NearObject), EntityZ(e\NearObject), EntityX(e\room\Objects[0],True), EntityZ(e\room\Objects[0],True))<2.0) Then
						...
						Select e\EventState
							...
							Case 66
								...
								EndIf
							Case 67
								If (Rand(150)=1) And (Distance(EntityX(e\NearObject), EntityZ(e\NearObject), EntityX(e\room\Objects[0],True), EntityZ(e\room\Objects[0],True))<2.0 And e\NearObject = Collider) Then
									...
									If (Injuries>5.0) Kill("was killed by SCP-205")
								EndIf
								
								TranslateEntity(e\NearObject, e\EventState2,0,e\EventState3)
			...
			Case e_room079
				...
				If PlayerInRoom(e) Then
					...
					If PlayerRoom = e\room Then ShouldPlay = 4
					If RemoteDoorOn Then	
						If e\room\RoomDoors[0]\open Then 
							If e\room\RoomDoors[0]\openstate > 50 Or EntityDistance(e\NearObject, e\room\RoomDoors[0]\frameobj)<0.5 Then
								e\room\RoomDoors[0]\openstate = Min(e\room\RoomDoors[0]\openstate,50)
								e\room\RoomDoors[0]\open = False
								If PlayerRoom = e\room Then PlaySound_Strict (LoadTempSound("SFX\Door\DoorError.ogg"))
							EndIf							
						EndIf
					ElseIf e\EventState < 10000
						...
						ElseIf e\EventState = 2
							If EntityDistance(e\room\Objects[0], e\NearObject)<3.0 Then 
								e\EventState = 3
								e\EventState2 = 1
						...
						ElseIf e\EventState < 2000 Then ;3500
							...
							EndIf
						Else
							If EntityDistance(e\room\Objects[0], e\NearObject)<2.5 Then 
								e\EventState = 10001
			...
			Case e_room3storage
				...
				If PlayerInRoom(e) Then
					...
					If EntityY(e\NearObject)<-4600*RoomScale Then
						...
						If e\room\RoomDoors[4]\open = False
							If UpdateLever(e\room\Levers[0])
								...
								If PlayerRoom = e\room And EntityY(Collider)<-4600*RoomScale Then
									If e\Sound2 <> 0 Then FreeSound_Strict e\Sound2 : e\Sound2=0
						...
						If PlayerRoom = e\room Then
							If Not GodMode Then
								If EntityY(Collider)<-6400*RoomScale And KillTimer >= 0 And FallTimer >= 0 And (Not player_isdead()) Then
									DeathMSG=""
									PlaySound_Strict LoadTempSound("SFX\Room\PocketDimension\Impact.ogg")
									multiplayer_WriteTempSound "SFX\Room\PocketDimension\Impact.ogg"
									Kill()
			...
			Case e_alarm ;the alarm in the starting room
				;[Block]
				e\room\objectstatic[0] = False
				e\room\objectstatic[1] = False
				...
				If e\EventState = 0 Then
					...
					If NetworkServer\MainPlayer Then
						If Rand(10) = 3 Then
							For i = 2 To Rand(2,3)
								it.items = CreateItem("Uranium Candy", "urancandy", EntityX(Collider), EntityY(Collider)+0.32, EntityZ(Collider))
								it.items = CreateItem("Cooked Chicken", "chicken", EntityX(Collider), EntityY(Collider)+0.32, EntityZ(Collider))
							Next
						EndIf
					EndIf
				Else
...
Function UpdateEvents()
	...
	CurrStepSFX = 0
	If Not(QuickLoadPercent = -1 Or QuickLoadPercent = 100) Then Return True
	
	If NetworkServer\Breach Then Return UpdateBreachEvents()
	MyPlayer\PlayerRoomName = PlayerRoom\RoomTemplate\Name
	MyPlayer\PlayerRoomID = PlayerRoom\ID
	For e.Events = Each Events
		...
		Select e\EventConst
			...
			Case e_exit1
				;[Block]
				e\StaticEvent = False
				If (PlayerInRoom(e) And EntityY(GetObject(e)) > 1040.0*RoomScale) Then UpdateEnding(e)
				...
				ElseIf RemoteDoorOn And e\EventState3=0
					...
					If e\room\RoomDoors[4]\open Then 
						If e\room\RoomDoors[4]\openstate > 50 Or EntityDistance(e\NearObject, e\room\RoomDoors[4]\frameobj)<0.5 Then
				...
				If e\EventState = 0 Then
					If PlayerInRoom(e) Then
						...
						If NetworkServer\MainPlayer Then
							If Rand(30) = 3 Then
								For i = 2 To Rand(2,3)
									CreateItem("Uranium Candy", "urancandy", EntityX(Collider), EntityY(Collider)+0.32, EntityZ(Collider))
									CreateItem("Cooked Chicken", "chicken", EntityX(Collider), EntityY(Collider)+0.32, EntityZ(Collider))
								Next
							EndIf
						EndIf
						e\EventState = 1
					...
					If e\EventState >= 500 Then
						...
						If e\EventState2 = 0 Then
							...
							If e\EventState > 900 And e\room\RoomDoors[5]\open Then
								...
								;UpdateSoundOrigin(e\room\NPC[1]\SoundChn,Camera, e\room\NPC[1]\obj)
								...
								Else
									If e\EventState-FPSfactor < 900+4*70 Then 
										...
										If EntityY(e\NearObject)<320*RoomScale Then BlinkTimer = -10
									EndIf
									...
									If e\room\NPC[2]\State <> 1 And KillTimer >= 0
										If EntityZ(e\room\NPC[2]\Collider) < e\room\z-1150*RoomScale Then
											...
											BlinkTimer = -10
											PlaySound2 (StoneDragSFX, Camera, Curr173\Collider)
											If EntityDistance(Curr173\Collider,e\NearObject)<2.5 And Abs(EntityY(e\NearObject)-EntityY(Curr173\Collider))<1.0 Then
                                                PositionEntity Curr173\Collider, EntityX(e\NearObject),EntityY(e\NearObject),EntityZ(e\NearObject)
                                            Else
								...
								If (CurrTrigger = "173scene_end") And EntityVisible(e\room\NPC[2]\Collider, e\NearObject) And (Not NoTarget) Then
									e\room\NPC[2]\State = 1
									e\room\NPC[2]\State3 = 1
								ElseIf e\room\NPC[2]\State = 1 And (Not EntityVisible(e\room\NPC[2]\Collider, e\NearObject))
							...
							Else
								CanSave = True
								If e\room\NPC[2]\State <> 1
									If EntityX(e\NearObject)<(e\room\x+1384*RoomScale) Then e\EventState = Max(e\EventState,900)
			...
			Case e_173 ;the intro sequence
				...
				If KillTimer >= 0 And e\EventState2 = 0 And e\room <> Null Then
					PlayerZone = 0
					...
					If e\EventState3>0 Then
						...
						ElseIf e\EventState3 => 150.0 And e\EventState3 < 700
							...
							Else
								...
								;PointEntity e\room\NPC[3]\obj, e\NearObject
								;RotateEntity e\room\NPC[3]\Collider, 0, EntityYaw(e\room\NPC[3]\obj), 0
								
								;PointEntity e\room\NPC[4]\obj, e\NearObject
								;RotateEntity e\room\NPC[4]\Collider, 0, EntityYaw(e\room\NPC[4]\obj), 0
								
								e\EventState3 = Min(e\EventState3+FPSfactor/4,699)
								
								;outside the cell
								If Distance(EntityX(e\NearObject),EntityZ(e\NearObject),e\room\x-(3072+1024)*RoomScale, e\room\z+192.0*RoomScale)>1.5 Then
									;e\room\NPC[3]\State = 5
									;e\room\NPC[3]\EnemyX = EntityX(e\NearObject)
									;e\room\NPC[3]\EnemyY = EntityY(e\NearObject)
									;e\room\NPC[3]\EnemyZ = EntityZ(e\NearObject)
									...
									If e\EventState3 > 250 Then
										...
										e\room\NPC[3]\PathStatus = FindPath(e\room\NPC[3],e\room\x-320*RoomScale, 0.3, e\room\z-704*RoomScale)
										e\room\NPC[4]\PathStatus = FindPath(e\room\NPC[4],e\room\x-320*RoomScale, 0.3, e\room\z-704*RoomScale)
										
										e\EventState3 = 710
									EndIf
								Else ;inside the cell
									e\room\NPC[3]\State = 9
									;PointEntity e\room\NPC[3]\Collider, e\NearObject		
									...
									ElseIf e\EventState3>630
										...
										If e\room\RoomDoors[6]\open = True Then 
											...
											em.Emitters = CreateEmitter(e\room\x - (2976.0+1024) * RoomScale, 373.0 * RoomScale, e\room\z + 204.0 * RoomScale, 0)
											TurnEntity(em\Obj, 90, 0, 0, True)
											em\RandAngle = 7
											em\Speed = 0.03
											em\SizeChange = 0.003
											em\Room = e\room
											InitRoomForEmitter(em)
											
											em.Emitters = CreateEmitter(e\room\x - (3168.0+1024) * RoomScale, 373.0 * RoomScale, e\room\z + 204.0 * RoomScale, 0)
											TurnEntity(em\Obj, 90, 0, 0, True)
											em\RandAngle = 7
											em\Speed = 0.03
											em\SizeChange = 0.003
						...
						ElseIf e\EventState3 < 800
							...
							If e\room\NPC[5]\State <> 11
								If EntityDistance(e\room\NPC[3]\Collider,e\room\NPC[5]\Collider)>5.0 And EntityDistance(e\room\NPC[4]\Collider,e\room\NPC[5]\Collider)
									If EntityDistance(e\room\NPC[5]\Collider,Player[e\room\NPC[5]\NearID]\Pivot)<3.5
						...
						ElseIf e\EventState3 < 900
							...
							If EntityX(e\NearObject)<EntityX(e\room\obj,True)-5376*RoomScale And e\EventStr = "" Then
								If Rand(3)=1 Then
							...
							If e\room\NPC[6]<>Null Then ;the scientist
								If e\room\NPC[6]\State = 0 Then 
									If e\room\RoomDoors[7]\open Then 
										If Distance(EntityX(e\NearObject), EntityZ(e\NearObject), EntityX(e\room\obj,True)-3328*RoomScale, EntityZ(e\room\obj,True)-1232*RoomScale)<5.0 Then
							...
							If e\room\NPC[8]<>Null Then ;the 2 guards and ClassD
								If e\room\NPC[8]\State = 7 Then
									;If e\room\RoomDoors[7]\open Then 
									If Distance(EntityX(e\NearObject), EntityZ(e\NearObject), EntityX(e\room\obj,True)-6688*RoomScale, EntityZ(e\room\obj,True)-1252*RoomScale)<2.5 Then
							...
							If e\EventStr <> "" And e\EventStr <> "done" Then
								...
								EndIf
							EndIf
							If Player[e\room\NPC[3]\NearID] = Null Then 
								e\room\NPC[3]\NearID = FindNearestID(e\room\NPC[3])
							EndIf
							e\room\NPC[3]\NearObject = Player[e\room\NPC[3]\NearID]\Pivot
							dist = Distance(EntityX(e\room\NPC[3]\NearObject), EntityZ(e\room\NPC[3]\NearObject), EntityX(e\room\NPC[3]\Collider), EntityZ(e\room\NPC[3]\Collider))
							...
							If e\room\NPC[3]\State <> 11 Then
								If dist < Min(Max(4.0-e\room\NPC[3]\State3*0.05, 1.5),4.0) Then
									If e\room\NPC[3]\PathStatus <> 1 Then
										e\room\NPC[3]\State = 7
										PointEntity e\room\NPC[3]\obj, Player[e\room\NPC[3]\NearID]\Pivot
								...
								Else
									...
									If dist > 5.5 Then
										...
										e\room\NPC[3]\State = 5
										e\room\NPC[3]\EnemyX = EntityX(Player[e\room\NPC[3]\NearID]\Pivot)
										e\room\NPC[3]\EnemyY = EntityY(Player[e\room\NPC[3]\NearID]\Pivot)
										e\room\NPC[3]\EnemyZ = EntityZ(Player[e\room\NPC[3]\NearID]\Pivot)
										;e\room\NPC[3]\PathStatus = FindPath(e\room\NPC[3],EntityY(e\NearObject), 0.3, EntityZ(e\NearObject))
									EndIf
								EndIf	
								
								;PointEntity e\room\NPC[5]\obj, e\NearObject
								;RotateEntity e\room\NPC[5]\Collider, 0, CurveAngle(EntityYaw(e\room\NPC[5]\obj),EntityYaw(e\room\NPC[5]\Collider),30), 0
								
								If Player[e\room\NPC[4]\NearID] = Null Then 
									e\room\NPC[4]\NearID = FindNearestID(e\room\NPC[4])
								EndIf
								e\room\NPC[4]\NearObject = Player[e\room\NPC[4]\NearID]\Pivot
								dist = Distance(EntityX(e\room\NPC[4]\NearObject), EntityZ(e\room\NPC[4]\NearObject), EntityX(e\room\NPC[4]\Collider), EntityZ(e\room\NPC[4]\Collider))
								
								If dist > 1.5 And EntityDistance(e\room\NPC[4]\Collider, e\room\NPC[4]\NearObject)<EntityDistance(e\room\NPC[3]\Collider,e\room\NPC[4]\Collider) Then
									e\room\NPC[4]\State = 3	
									
								Else
									e\room\NPC[4]\State = 5
									e\room\NPC[4]\EnemyX = EntityX(Player[e\room\NPC[4]\NearID]\Pivot)
									e\room\NPC[4]\EnemyY = EntityY(Player[e\room\NPC[4]\NearID]\Pivot)
									e\room\NPC[4]\EnemyZ = EntityZ(Player[e\room\NPC[4]\NearID]\Pivot)
								EndIf
								
							EndIf
							
							Local acceptTo = True
							If Distance(EntityX(e\room\NPC[3]\Collider),EntityZ(e\room\NPC[3]\Collider),EntityX(e\room\RoomDoors[2]\frameobj,True),EntityZ(e\room\RoomDoors[2]\frameobj,True)) < 4.5 Then
								e\room\NPC[3]\State = 7
								e\room\NPC[4]\State = 7
								For i = 1 To NetworkServer\Maxplayers
									If Player[i] <> Null Then
										dist# = Distance(EntityX(Player[i]\Pivot), EntityZ(Player[i]\Pivot), EntityX(e\room\RoomDoors[2]\frameobj,True), EntityZ(e\room\RoomDoors[2]\frameobj,True))
										If dist > 4.0 Then acceptTo = False : Exit
									EndIf
								Next
							Else
								acceptTo = False
						...
						ElseIf e\EventState3 <= 905
							...
							ElseIf e\room\NPC[3]\Frame >= 358.0 Then
								PointEntity e\room\NPC[3]\Collider,Player[e\room\NPC[3]\NearID]\Pivot
								RotateEntity e\room\NPC[3]\Collider,0,EntityYaw(e\room\NPC[3]\Collider),0
								
								;acceptTo = True
								;For i = 1 To NetworkServer\Maxplayers
								;	if Player[i] <> Null Then
								;		dist# = Distance(EntityX(Player[i]\Pivot), EntityZ(Player[i]\Pivot), EntityX(e\room\obj), EntityZ(e\room\obj))
								;		If dist > 4.0 Then acceptTo = False : Exit
								;	EndIf
								;Next
								;If acceptTo Then
					...
					Else
						...
						If e\EventState = 0 Then
							If PlayerInRoom(e) Then
								...
								e\room\NPC[9]\texture = "GFX\npcs\classd3.jpg"
								ChangeNPCTextureID(e\room\NPC[9], 9)
								...
								PositionEntity Collider, e\room\x-(3072+1024)*RoomScale, 0.3, e\room\z+192.0*RoomScale
								ResetEntity Collider
						...
						ElseIf e\EventState < 10000
							...
							ElseIf e\EventState > 230
								...
								For i = 1 To 2
									If Distance(EntityX(e\room\NPC[i]\Collider), EntityZ(e\room\NPC[i]\Collider), EntityX(e\room\Objects[i + 2], True), EntityZ(e\room\Objects[i + 2], True)) > 0.3 Then
										...
										;moveentity(e\room\npc(i).e\NearObject, 0, 0, 0.015 * FPSfactor)
								...
								If EntityX(e\NearObject) < (EntityX(e\room\obj)) + 408.0 * RoomScale Then
									...
									If e\EventState > 850 Then
										PositionEntity(e\NearObject, Min(EntityX(e\NearObject), EntityX(e\room\obj) + 352.0 * RoomScale), EntityY(e\NearObject), EntityZ(e\NearObject))
									End If
							...
							PointEntity e\room\NPC[6]\obj, e\NearObject
						...
						ElseIf e\EventState < 14000 ; player is inside the room
							...
							If e\EventState < 10300 Then
								PositionEntity(e\NearObject, Max(EntityX(e\NearObject), EntityX(e\room\obj) + 352.0 * RoomScale), EntityY(e\NearObject), EntityZ(e\NearObject))
							End If
							...
							If e\EventState => 10440 And e\EventState - FPSfactor < 11561
								If e\room\NPC[0]\State <> 12 Then
									If Player[e\room\NPC[0]\NearID] = Null Then 
										e\room\NPC[0]\NearID = FindNearestID(e\room\NPC[0])
									EndIf
									e\room\NPC[0]\NearObject = Player[e\room\NPC[0]\NearID]\Pivot
									If EntityX(e\room\NPC[0]\NearObject) < EntityX(e\room\RoomDoors[1]\frameobj, True)
						...
						ElseIf e\EventState < 20000
							...
							RotateEntity(e\NearObject, EntityPitch(e\NearObject), CurveAngle(EntityYaw(pvt), EntityYaw(e\NearObject), 40), 0)
							...
							ElseIf e\EventState < 14200 ;kills the other class d
								...
								If e\EventState > 14105 Then
									...
									ResetEntity(Curr173\Collider)
									PointEntity(Curr173\Collider, e\NearObject)
								EndIf
							...
							Else
								...
								If e\EventState > 14300 Then 
									...
									If EntityX(e\NearObject) < (EntityX(e\room\obj)) + 448.0 * RoomScale Then e\EventState = 20000
								EndIf
							End If
							...
							Else
								...
								Else ;lights out, guard dies
									...
									If e\EventState - FPSfactor < 20300 Then
										...
										PositionEntity(Curr173\Collider, EntityX(e\room\obj) - 400.0 * RoomScale, 100.0, EntityZ(e\room\obj) + 1072.0 * RoomScale)
										ResetEntity(Curr173\Collider)
				...
				If PlayerInRoom(e) And IntroEnabled Then
			...
			Case e_buttghost
				;[Block]
				If PlayerInRoom(e) Then
					If EntityDistance(e\NearObject, e\room\Objects[0]) < 1.8 Then
						If e\EventState = 0
			...
			Case e_room1123
				...
				If PlayerRoom = e\room Then
					...
					If e\EventState = 1 Then
						...
						e\room\Objects[27] = LoadAnimMesh_Strict("GFX\npcs\naziofficer.b3d")
						RotateEntity e\room\Objects[27], EntityPitch(e\room\Objects[27]), EntityYaw(e\room\Objects[27]), EntityRoll(e\room\Objects[27])
						EntityType e\room\Objects[27], HIT_MAP
						
						e\room\Objects[28] = CreatePivot()
						EntityRadius e\room\Objects[28], 0.32
						EntityType e\room\Objects[28], HIT_PLAYER
						
						scale# = 0.5 / MeshWidth(e\room\Objects[27])
						ScaleEntity e\room\Objects[27], scale, scale, scale
					...
					ElseIf e\EventState = 2
						...
						PointEntity e\room\Objects[27], Collider
						RotateEntity e\room\Objects[27], 0, EntityYaw(e\room\Objects[27])-180, 0
						...
						If e\EventState2 > 1000 Then
							...
							If e\EventState2=>1040 And e\EventState2-FPSfactor<1040 Then 
								PlaySound2(LoadTempSound("SFX\SCP\1123\Officer1.ogg"), Camera, e\room\Objects[27])
							ElseIf e\EventState2=>1400 And e\EventState2-FPSfactor<1400 Then 
								PlaySound2(LoadTempSound("SFX\SCP\1123\Officer2.ogg"), Camera, e\room\Objects[27])
							EndIf
							Animate2(e\room\Objects[27],AnimTime(e\room\Objects[27]), 3,26,0.2)
					...
					ElseIf e\EventState=3
						If e\room\RoomDoors[0]\openstate>160 Then
							...
							PositionEntity e\room\Objects[27], EntityX(e\room\Objects[7],True),EntityY(e\room\Objects[7],True)-0.32,EntityZ(e\room\Objects[7],True)
							PositionEntity e\room\Objects[28], EntityX(e\room\Objects[7],True),EntityY(e\room\Objects[7],True),EntityZ(e\room\Objects[7],True)
							e\EventState=4
						EndIf
					ElseIf e\EventState=4
						...
						Else
							...
							If EntityYaw(e\room\Objects[13], False)>30 Then
								PointEntity e\room\Objects[27], Collider
								RotateEntity e\room\Objects[27], 0, EntityYaw(e\room\Objects[27])-180, 0
								Animate2(e\room\Objects[27], AnimTime(e\room\Objects[27]), 27, 54, 0.5, False)
								If AnimTime(e\room\Objects[27]) => 54 Then
									e\EventState = 5
									e\EventState2 = 0
					...
					ElseIf e\EventState = 5
						...
						If e\EventState2 > 500 Then 
							...
							PositionEntity e\room\Objects[27], x,y-0.32,z
							PositionEntity e\room\Objects[28], x,y+0.2,z
							...
							e\Sound2 = LoadSound_Strict("SFX\SCP\1123\Officer3.ogg")
					...
					ElseIf e\EventState = 6
						PointEntity e\room\Objects[27], Collider
						RotateEntity e\room\Objects[27], 0, EntityYaw(e\room\Objects[27])-180, 0
						Animate2(e\room\Objects[27], AnimTime(e\room\Objects[27]), 75, 128, 0.04, True)	
						If e\Sound2<>0 Then 
							...
							If e\Sound2<>0 Then e\SoundCHN2 = LoopSound2(e\Sound2, e\SoundCHN2, Camera, e\room\Objects[27], 7.0)
						EndIf
					ElseIf e\EventState=7
						...
						FreeEntity e\room\Objects[28]
						FreeEntity e\room\Objects[27]
						RemoveEvent(e)						
					End If
				EndIf
			Case e_checkpoint
				...
				If PlayerInRoom(e) Then
					...
					ElseIf e\room\Objects[1]<>0
						If e\EventState3 = 1 Then
							PointEntity e\room\Objects[1], e\NearObject
							RotateEntity e\room\Objects[1], -90, EntityYaw(e\room\Objects[1]),0
							angle = WrapAngle(DeltaYaw(e\NearObject, e\room\Objects[1]))
				...
				Else
					For e2.Events = Each Events
						If e2\EventConst = e_room2sl Then
							If e2\EventState3 = 0
								TurnCheckpointMonitorsOff(0)
								e\room\RoomDoors[0]\locked = False
								e\room\RoomDoors[1]\locked = False
					...
					If e\room\NPC[0]<>Null Then
						...
						ElseIf e\room\NPC[0]\PrevState = 1 Then
							...
							If EntityY(e\room\NPC[0]\Collider)>(-1531.0*RoomScale)+0.35 Then
								dist# = EntityDistance(e\NearObject,e\room\NPC[0]\Collider)
								If dist<0.8 Then ;get the player out of the way
									fdir# = point_direction(EntityX(e\NearObject,True),EntityZ(e\NearObject,True),EntityX(e\room\NPC[0]\Collider,True),EntityZ(e\room\NPC[0]\Collider,True))
									TranslateEntity e\NearObject,Cos(-fdir+90)*(dist-0.8)*(dist-0.8),0,Sin(-fdir+90)*(dist-0.8)*(dist-0.8)
								EndIf
			...
			Case e_endroom106
				...
				If (Not Contained106) Then
					...
					ElseIf e\EventState = 1
						If PlayerInRoom(e) Then
							...
							If PlayerRoom = e\room Then PlaySound_Strict(e\Sound)		
					...
					Else
						...
						EndIf
						CurrSpeed = Min(CurrSpeed - (CurrSpeed * (0.15/EntityDistance(e\room\NPC[0]\Collider, e\NearObject)) * FPSfactor), CurrSpeed)
						If e\EventState > 100 Then
							...
							Curr106\Idle = False
							If EntityDistance(e\NearObject, e\room\obj)<2.5 Then Curr106\State=-0.1
				...
				;[End Block]
			Case e_gatea
				If PlayerInRoom(e) Then UpdateEnding(e)
			Case e_gateaentrance
				;[Block]
				e\StaticEvent = False
				If PlayerInRoom(e) Then 
					...
					ElseIf RemoteDoorOn And e\EventState3=0
						...
						If e\room\RoomDoors[1]\open Then 
							If e\room\RoomDoors[1]\openstate > 50 Or EntityDistance(e\NearObject, e\room\RoomDoors[1]\frameobj)<0.5 Then
			...
			Case e_lockroom173
				...
				If e\dist < 6.0  And e\dist > 0 Then
					...
					Else
						...
						If (Not EntityInView(Curr173\Collider, GetPlayerCamera(e\NearObjectQueue))) Or EntityDistance(Curr173\Collider, e\NearObject)>15.0 Then 
			...
			Case e_pj
				...
				If PlayerInRoom(e) Then
					If e\EventState = 0 Then
						If EntityDistance(e\NearObject, e\room\obj) < 2.5 Then
			...
			Case e_pocketdimension
				...
				If PlayerRoom=e\room Then
					...
					If EntityDistance(e\NearObject, Curr106\Collider) < 0.3 Then ;106 attacks if close enough to player
						Curr106\Idle = False
						Curr106\State = -10
					EndIf
					...
					If e\EventState2 = 1 Then ;in the second room
						...
						Else
							...
							If EntityY(e\NearObject)>6.0 Then
								...
								;check if player is at the sinkhole (the exit from the trench room)
								If EntityY(e\NearObject)<8.5 And (Not multiplayer_IsFullSync()) Then
									LoadEventSound(e,"SFX\Room\PocketDimension\Rumble.ogg")
									LoadEventSound(e,"SFX\Room\PocketDimension\PrisonVoices.ogg",1)
							...
							Else
								...
								If temp < 2000*RoomScale Then
									...
									;teleport the player to the trenches
									If Crouch And  (Not multiplayer_IsFullSync()) Then
										BlinkTimer = -10
										PositionEntity e\NearObject, EntityX(e\room\Objects[8],True)-1344*RoomScale,2944*RoomScale,EntityZ(e\room\Objects[8],True)-1184*RoomScale
										ResetEntity e\NearObject
										Crouch = False
			...
			Case e_room2closets
				;[Block]
				If e\EventState = 0 Then
					If PlayerInRoom(e) And Curr173\Idle<2 Then
						If e\EventStr = "" And QuickLoadPercent = -1
							QuickLoadPercent = 0
							QuickLoad_CurrEvent = e
							e\EventStr = "load0"
					...
					Else
						...
						If BlinkTimer =-10 Then
							If e\EventState > 70*7.5 And e\EventState-FPSfactor =< 70*7.5 Then
								...
								MoveEntity it\collider,0,0.5,0
								For i = 0 To 1
									it2.Items = CreateItem("Quarter","25ct",EntityX(e\room\NPC[0]\Collider,True),EntityY(e\room\NPC[0]\Collider,True),EntityZ(e\room\NPC[0]\Collider,True))
									it2\Picked = False
			...
			Case e_room2doors173
				...
				If PlayerInRoom(e) Then
					If e\EventState = 0 And Curr173\Idle = 0 Then
						...
						If (Not EntityInView(Curr173\obj, GetPlayerCamera(e\NearObjectQueue))) Then
							e\EventState = 1
			...
			Case e_room2elevator
				...
				If e\EventState = 0 Then
					If e\dist < 8.0 And e\dist > 0 Then
						...
						PointEntity e\room\NPC[0]\Collider, e\NearObject
						RotateEntity e\room\NPC[0]\Collider, 0, EntityYaw(e\room\NPC[0]\Collider),0, True	
			...
			Case e_room2offices3
				...
				If PlayerInRoom(e) Then
					...
					If e\EventState > 700 Then
						If EntityDistance(e\room\RoomDoors[0]\obj, e\NearObject)>0.5 Then
							
							If EntityInView(e\room\RoomDoors[0]\obj, GetPlayerCamera(e\NearObjectQueue))=False Then
			...
			Case e_room2tesla
				...
				If temp And (EntityY(e\NearObject, True) > EntityY(e\room\obj,True) Or EntityY(Collider, True) > EntityY(e\room\obj,True)) And (EntityY(e\NearObject, True) < 4.0 Or EntityY(Collider, True) < 4.0) Then
					...
					If e\EventState = 0 Then
						...
						If e\dist < 8 Then		
							...
							Local temp3 = 0
							If temp2
								If e\EventStr = "" And PlayerInRoom(e)
									If EntityDistance(e\room\Objects[5],e\NearObject)<EntityDistance(e\room\Objects[6],e\NearObject)
										temp3 = 6
									Else
										temp3 = 5
									EndIf
			...
			Case e_room2trick
				...
				e\NearObject = Collider
				If PlayerRoom = e\room Then
					If EntityDistance(e\room\obj,e\NearObject)<2.0 Then
						If EntityDistance(e\NearObject, Curr173\obj)<6.0 Or EntityDistance(e\NearObject, Curr106\obj)<6.0 Then
							RemoveEvent(e)
						Else
							DebugLog "%@@= \ {2E6C2=FD gi`h]c"
							...
							PositionEntity e\NearObject, EntityX(pvt),EntityY(pvt)+0.05,EntityZ(pvt)
							UpdateWorld()
							;ResetEntity e\NearObject
							
							TurnEntity e\NearObject, 0,180,0
			...
			Case e_room2tunnel
				...
				If (PlayerInRoom(e) And NetworkServer\MainPlayer) Or PlayerRoom = e\room Then
					...
					If EntityY(e\NearObject,True)>4.0 Then
						If EntityY(Collider, True) > 4.0 Then ShouldPlay = 7
						...
						If e\EventState = 0 Then
							...
							If (Not Contained106) Then 	
								...
								DebugLog "updateevents collider: "+EntityY(e\NearObject,True)
								PositionEntity Curr106\Collider, EntityX(e\room\Objects[temp],True), EntityY(e\NearObject,True)-3.0, EntityZ(e\room\Objects[temp],True)
								SetAnimTime Curr106\obj, 110
								Curr106\State = -0.1	
								Curr106\PrevY = EntityY(e\NearObject)
							EndIf
							...
							For i = 0 To 1
								...
								If (spawnPoint<>Null) Then
									CreateNPC(NPCtype966, EntityX(spawnPoint\obj,True), EntityY(spawnPoint\obj,True), EntityZ(spawnPoint\obj,True))
								EndIf
							Next
						EndIf
					EndIf
			...
			Case e_room2pipes106
				...
				If (Not Contained106) Then 
					If e\EventState = 0 Then
						If PlayerInRoom(e) Then e\EventState = 1
					Else
						...
						If e\EventState < 50 Then
							Curr106\Idle = True
							PositionEntity(Curr106\Collider, EntityX(e\room\Objects[0], True), EntityY(e\NearObject) - 0.15, EntityZ(e\room\Objects[0], True))
						...
						ElseIf e\EventState < 200
							...
							PositionEntity(Curr106\Collider, (EntityX(e\room\Objects[0], True)+EntityX(e\room\Objects[1], True))/2, EntityY(e\NearObject) - 0.15, (EntityZ(e\room\Objects[0], True)+EntityZ(e\room\Objects[1], True))/2)
							...
							If EntityDistance(Curr106\Collider, e\NearObject)<4.0 Then
								pvt = CreatePivot()
						...
						;PositionEntity(Curr106\Collider, EntityX(Curr106\Collider), EntityY(e\NearObject) - 0.20, EntityZ(Curr106\Collider))
			...
			Case e_room3pitduck
				...
				If PlayerInRoom(e) Then
					...
					Else
						...
						If EntityInView(e\room\Objects[2],GetPlayerCamera(e\NearObjectQueue))=False Then
							e\EventState = e\EventState + FPSfactor
			...
			Case e_room3pit1048
				...
				If PlayerInRoom(e) Then
					...
					Else
						PointEntity e\room\Objects[2], e\NearObject
						RotateEntity(e\room\Objects[2], -90, EntityYaw(e\room\Objects[2],True),0, True)
						
						If e\EventState=0 Then
							If (EntityDistance(e\NearObject, e\room\Objects[2])<3.0) Then
				...
				If PlayerInRoom(e) Then
					If e\EventState = 0 Then
						If e\room\RoomDoors[0]\open = True Then 
							...
							EndIf
						Else
							If (EntityDistance(e\NearObject, e\room\RoomDoors[0]\obj)<1.5) And (RemoteDoorOn) Then
								e\room\RoomDoors[0]\open = True
							EndIf
						EndIf
					Else
						If EntityDistance(e\room\Objects[0], e\NearObject) < 2.0 Then
				...
				If e\EventState=0 Then
					If 0 Then
						If PlayerInRoom(e) Then
							...
							e\SoundCHN = PlaySound_Strict (e\Sound)
							ChannelVolume(e\SoundCHN, (PlayerRoom=e\room)*SFXVolume)
						...
						EndIf
					Else
						If Curr096=Null Then Curr096 = CreateNPC(NPCtype096, EntityX(e\room\Objects[6],True),EntityY(e\room\Objects[6],True)+0.1,EntityZ(e\room\Objects[6],True))
					EndIf
...
;						EndIf
						...
						ElseIf e\EventState >= 70*8 And e\EventState < 70*10
							...
							If EntityDistance(e\NearObject,e\room\RoomDoors[0]\frameobj)<EntityDistance(e\NearObject,e\room\RoomDoors[1]\frameobj)
					...
					Else
						...
						If PlayerInRoom(e) Then
							If e\SoundCHN<>0 Then
								If	ChannelPlaying(e\SoundCHN) Then 
									If PlayerRoom = e\room Then LightBlink = Rnd(0.5,6.0)
							...
							If (e\room\angle = 0 Or e\room\angle = 180) Then ;lock the player inside
								If Abs(EntityX(e\NearObject)-EntityX(e\room\obj,True))> 1.3 Then 
									e\EventState = 70*50
									e\Sound=0
								EndIf
							Else
								If Abs(EntityZ(e\NearObject)-EntityZ(e\room\obj,True))> 1.3 Then 
									e\EventState = 70*50
									e\Sound=0
								EndIf
							EndIf	
			...
			Case e_room2storage
				...
				If PlayerRoom = e\room Then
					...
					If e\EventState2 <= 0 Then
						...
						If EntityDistance(e\NearObject, Curr173\obj)<8.0 Or EntityDistance(e\NearObject, Curr106\obj)<8.0 Then
							e\room\RoomDoors[1]\locked = True
							e\room\RoomDoors[4]\locked = True
						Else
							For n.NPCs = Each NPCs
								If n\NPCtype = NPCtypeMTF Then 
									If EntityDistance(e\NearObject, Curr173\obj)<8.0 Then 
										e\room\RoomDoors[1]\locked = True
										e\room\RoomDoors[4]\locked = True
										Exit
									EndIf
					...
					Else
						...
						If e\room\NPC[1] <> Null Then
							PointEntity e\room\NPC[1]\obj, e\NearObject
				...
				;	If Abs(EntityX(e\NearObject)-e\room\x)<8.0 Then
				;		If Abs(EntityZ(e\NearObject)-e\room\z)<8.0 Then
				;			If e\Sound = 0 Then
			...
			Case e_room3door
				;[Block]
				If PlayerInRoom(e) Then
					If EntityDistance(e\room\obj,e\NearObject)<2.5 Then
						For do.doors = Each Doors
							If Abs(EntityX(do\obj,True)-EntityX(e\NearObject))<2.0 Then
								If Abs(EntityZ(do\obj,True)-EntityZ(e\NearObject))<2.0 Then
									
									If (Not EntityInView(do\obj,GetPlayerCamera(e\NearObjectQueue))) Then
										If do\open Then
											DebugLog "%@@= \ {2E6C2=FD gi`h]c"
											do\open = False
											do\openstate = 0
			...
			Case e_room3storage
				...
				If PlayerInRoom(e) Then
					...
					If EntityY(e\NearObject)<-4600*RoomScale Then
						...
						;If PlayerRoom = e\room Then ShouldPlay = 7
							...
							If PlayerRoom = e\room Then
								If Not GodMode Then
									If EntityY(Collider)<-6400*RoomScale And KillTimer >= 0 And FallTimer >= 0 And (Not player_isdead()) Then
										DeathMSG=""
										PlaySound_Strict LoadTempSound("SFX\Room\PocketDimension\Impact.ogg")
										multiplayer_WriteTempSound("SFX\Room\PocketDimension\Impact.ogg", EntityX(Collider), EntityY(Collider), EntityZ(Collider))
										Kill()
									EndIf
								EndIf
							EndIf
			...
			Case e_room4
				...
				If NetworkServer\MainPlayer Then
					If e\EventState < MilliSecs2() Then
						If PlayerRoom <> e\room Then
							If Distance(EntityX(e\NearObject),EntityZ(e\NearObject),EntityX(e\room\obj),EntityZ(e\room\obj))<16.0 Then
								For n.NPCs = Each NPCs
									If n\NPCtype = NPCtype049 Then
										If n\State = 2 And EntityDistance(e\NearObject,n\Collider)>16.0 Then
			...
			Case e_room035
				...
				If PlayerInRoom(e) Then
					...
					ElseIf e\EventState > 0
						...
						If e\EventState=1 Then
							If EntityDistance(e\NearObject, e\room\Objects[3])<1.2
								
								If EntityInView(e\room\NPC[0]\obj, GetPlayerCamera(e\NearObjectQueue)) Then
							...
							If UpdateLever(e\room\Levers[0],(e\EventState2=20)) = 0 Then
								...
								Else ;gas valves closed
									...
									If e\room\NPC[0]\State = 0 Then
										PointEntity e\room\NPC[0]\obj, e\NearObject
					...
					Else ;eventstate < 0 (SCP-035 has left)
						...
						If EntityX(Collider)>Min(EntityX(e\room\Objects[7],True),EntityX(e\room\Objects[8],True)) Then
							...
							EndIf
						EndIf
						If EntityX(e\NearObject)>Min(EntityX(e\room\Objects[7],True),EntityX(e\room\Objects[8],True)) Then
							If EntityX(e\NearObject)<Max(EntityX(e\room\Objects[7],True),EntityX(e\room\Objects[8],True)) Then
								If EntityZ(e\NearObject)>Min(EntityZ(e\room\Objects[7],True),EntityZ(e\room\Objects[8],True)) Then
									If EntityZ(e\NearObject)<Max(EntityZ(e\room\Objects[7],True),EntityZ(e\room\Objects[8],True)) Then
				...
				Else	
					If e\EventState=0 Then	
						If e\Sound = 0 Then
							If EntityDistance(e\NearObject, e\room\obj) < 20 Then
			...
			Case e_room049
				...
				e\room\RoomDoors[2]\liftstate = UpdateElevators(e\room\RoomDoors[2]\liftstate, e\room\RoomDoors[2], e\room\RoomDoors[3],e\room\Objects[2],e\room\Objects[3], True)
				If PlayerInRoom(e) Then
					If EntityY(e\NearObject) <= -2848*RoomScale Or EntityY(Collider) <= -2848*RoomScale Then
						If PlayerRoom = e\room Then ShouldPlay = 25
						If e\EventState = 0 Then
							If e\EventStr = "" And QuickLoadPercent = -1
								QuickLoadPercent = 0
								QuickLoad_CurrEvent = e
							...
							If EntityDistance(e\room\Objects[11],e\NearObject)<EntityDistance(e\room\Objects[12],e\NearObject) Then
							...
							If temp And x Then
								...
								If e\room\NPC[0] <> Null Then
									If e\room\NPC[0]\Idle > 0
										i = 0
										If EntityDistance(e\NearObject,e\room\RoomDoors[1]\frameobj)<3.0
											i = 1
										ElseIf EntityDistance(e\NearObject,e\room\RoomDoors[3]\frameobj)<3.0
											i = 3
										EndIf
										If i > 0
											...
											e\room\NPC[0]\PathStatus = FindPath(e\room\NPC[0],EntityX(e\NearObject),EntityY(e\NearObject),EntityZ(e\NearObject))
			...
			Case e_room106
				...
				If (PlayerInRoom(e) And e\room\NPC[0]<>Null) Then
					...
					If e\EventState = 0 Then 
						...
						If SoundTransmission Then
							...
							If ClosestButton = e\room\Objects[4] And MouseHit1 Then
								If Not multiplayer_Send(M_FEMUR) Then
									If e\EventState = 0 Then
										e\EventState = 1
					...
					ElseIf e\EventState = 1 ;bone broken
						...
						If e\EventState3 => 2500 Then
							...
							If Not Contained106 Then ShouldPlay = 10
					...
					;e\room\RoomDoors[0]\liftstate = UpdateElevators(e\room\RoomDoors[0]\liftstate, e\room\RoomDoors[0], e\room\RoomDoors[1], e\room\Objects[9], e\room\Objects[10])
				Else
					...
					ElseIf PlayerRoom\RoomTemplate\Name = "room860" Then
						For e2.Events = Each Events
							If e2\EventConst = e_room860 Then
						...
						Select e\EventState
							...
							Case 67
								If (Rand(150)=1) And (Distance(EntityX(e\NearObject), EntityZ(e\NearObject), EntityX(e\room\Objects[0],True), EntityZ(e\room\Objects[0],True))<2.0 And e\NearObject = Collider) Then
									...
									Injuries=Injuries+Rnd(0.4,0.8)
									PlaySound_Strict DamageSFX(Rand(2,3))
									multiplayer_WriteSound DamageSFX(Rand(2,3))
									CameraShake = 0.5
			...
			Case e_room860
					...
					If e\EventState=1.0 Then ;the player is in the forest
						...
						If e\room\NPC[0]<>Null Then
							If (e\room\NPC[0]\State2 = 1 And e\room\NPC[0]\State>1) Or e\room\NPC[0]\State>2 ;the monster is chasing the player
								If PlayerRoom = e\room Then ShouldPlay = 12
							Else
								If PlayerRoom = e\room Then ShouldPlay = 9
							EndIf
						EndIf
						...
						If e\room\NPC[0]<>Null
							If e\room\NPC[0]\NearObject <> 0 Then
								If e\room\NPC[0]\State = 0 Or EntityDistance(e\room\NPC[0]\NearObject, e\room\NPC[0]\Collider)>20.0 Then
				...
				Else
					If (fr<>Null) Then
						If (fr\Forest_Pivot<>0) And (Not PlayerInRoom(e)) Then HideEntity fr\Forest_Pivot
						If PlayerRoom\RoomTemplate\Name <> "dimension1499" And PlayerRoom\RoomTemplate\Name <> "pocketdimension" Then
							If e\EventState = 1.0 Then
				...
				If e <> Null Then
					If PlayerInRoom(e) Then
						If e\EventState = 0 Then
							...
							e\EventState = 1
						EndIf
						If EntityDistance(e\NearObject, e\room\Objects[6]) < 2.5 And e\EventState > 0 Then
			...
			Case e_tunnel2
				...
				If PlayerInRoom(e) Then
					...
					Else		
						If e\EventState = 0 Then
							If Distance(EntityX(e\NearObject), EntityZ(e\NearObject), EntityX(e\room\obj), EntityZ(e\room\obj)) < 3.5 Then
								PlaySound_Strict(LightSFX)
			...
			Case e_tunnel106
				...
				If e\EventState = 0 Then
					If e\dist < 5.0 And e\dist > 0 Then
						If Curr106\State >= 0 Then
							e\EventState = 1
						Else
							If Curr106\State <= -10 And EntityDistance(Curr106\Collider,e\NearObject)>5 And (Not EntityInView(Curr106\obj,GetPlayerCamera(e\NearObjectQueue))) Then
								e\EventState = 1
								e\EventState2 = 1
							EndIf
						EndIf
				...
				Else
					...
					If e\EventState <= 180 Then
						PositionEntity(Curr106\Collider, EntityX(e\room\obj, True), EntityY(e\NearObject) + 1.0 - Min(Sin(e\EventState)*1.5,1.1), EntityZ(e\room\obj, True), True)
						PointEntity(Curr106\Collider, Camera)
					...
					ElseIf e\EventState < 800
						If EntityY(Curr106\Collider)>=EntityY(e\NearObject)-0.05 Then
							RemoveEvent(e)
						Else
							TranslateEntity Curr106\Collider, 0, ((EntityY(e\NearObject,True) - 0.11) - EntityY(Curr106\Collider)) / 50.0, 0
				...
				If PlayerInRoom(e)	
					If Curr173\Idle = 0 Then 
						...
						Else
							...
							e\EventState = e\EventState + 1
							dist# = EntityDistance(e\NearObject, e\room\Objects[1])
							If dist <1.0 Then
			...
			Case e_008
				...
				If PlayerInRoom(e) Then	
					...
					;container open
					If e\EventState = 0 Then
						If Curr173\Idle<2 And EntityDistance(Curr173\Collider,e\NearObject)>HideDistance ;Just making sure that 173 is far away enough to spawn him to this room
					...
					ElseIf e\EventState = 1
						...
						dist = EntityDistance(e\NearObject, e\room\Objects[0])
						If dist<2.0 Then 
							e\room\RoomDoors[0]\locked = True
							e\room\RoomDoors[1]\locked = True
							...
							If e\EventState2=0 Then
								...
								If EntityDistance(Curr173\Collider,e\room\Objects[4])<3.0
									If (Player[e\NearObjectQueue]\BlinkTimer<-10 Or (Not EntityInView(Curr173\obj,GetPlayerCamera(e\NearObjectQueue)))) And Curr173\Idle = 0 Then
										...
										If (Not WearingHazmat) And EntityDistance(Collider, e\room\Objects[0]) < 2 Then
				...
				Else
					...
					Select e\EventState
						...
						Case 2
							...
							PointEntity(e\room\Objects[0], e\NearObject)
			...
			Case e_room2sl
				...
				If PlayerInRoom(e)
					...
					;if e\room\RoomDoors[1]\locked = True and e\room\RoomDoors[1]\open = false then e\room\RoomDoors[1]\open = true
				EndIf
				;[End Block]
						...
						If e\EventState2 = -(70*5)
							For sc.SecurityCams = Each SecurityCams
								If sc\room = e\room
									...
									If EntityDistance(sc\ScrObj,GetPlayerCamera(e\NearObjectQueue))<5.0
										If EntityVisible(sc\ScrObj,GetPlayerCamera(e\NearObjectQueue))
							...
							If e\EventState2 < 7
								If e\EventState2 > 2
									If Abs(EntityY(e\room\RoomDoors[0]\frameobj)-EntityY(e\room\NPC[0]\Collider))>1.0
										If Abs(EntityY(e\room\RoomDoors[0]\frameobj)-EntityY(e\NearObject))<1.0
											If e\room\RoomDoors[0]\open
												...
												;if NetworkServer\MainPlayer = False Then
												;	udp_WriteByte(M_DOOR)
												;	udp_WriteByte(NetworkServer\MyID)
												;	udp_WriteShort(e\room\RoomDoors[0]\ID)
												;	udp_WriteByte(e\room\RoomDoors[0]\open)
												;	udp_WriteByte(e\room\RoomDoors[0]\locked)
												;	udp_SendMessage()
												;EndIf
											EndIf
										EndIf
			...
			Case e_096spawn
				;[Block]
				If Not NetworkServer\MainPlayer Then e\EventState = 0 : e\dist = 100
				...
				If e\dist < HideDistance
					...
					If e\EventState <> 2
						If Curr096<>Null
							If EntityDistance(Curr096\Collider,e\NearObject)<40
								e\EventState = 2
							...
							If EntityDistance(Curr096\Collider,e\room\obj)>EntityDistance(Curr096\Collider,e\NearObject)
								e\EventState = 2
								DebugLog "Failed to spawn SCP-096 in room "+e\room\RoomTemplate\Name$
						...
						For e2.Events = Each Events
							If e2\EventName = "room2servers"
								If e2\EventState = 0 ;And (Abs(e2\room\dist-e\dist)<HideDistance)
									e\EventState = 2
									DebugLog "Failed to spawn SCP-096 in room "+e\room\RoomTemplate\Name$
							...
							EndIf
						Next
						If PlayerInRoom(e) Then e\EventState = 2
					EndIf
					...
					If e\EventState = 0
						...
						Else
							...
							ResetEntity Curr096\Collider
						EndIf
						PointEntity Curr096\Collider,e\NearObject
					...
					ElseIf e\EventState = 1
						...
						If EntityDistance(Curr096\Collider,e\NearObject)<HideDistance*0.5
			...
			Case e_medibay
				...
				Else
					...
					If EntityDistance(e\room\NPC[0]\Collider,e\NearObject)<1.2
						If e\EventState2 = 0
							LightBlink = 12.0
							PlaySound_Strict LightSFX
			...
			Case e_room2offices035
				...
				For e2.Events = Each Events
					If e2<>e And e2\EventConst=e_room035 Then
				...
				If is035released
					If e\dist < 8
						...
						If e\room\NPC[1]=Null
							If EntityDistance(e\room\NPC[0]\Collider,e\NearObject)<2.5
	...
	If NetworkServer\MainPlayer = True Then
		For e.Events = Each Events
			For i = 0 To 11
				If e\room\NPC[i] <> Null Then
					e\room\NPC[i]\EventID = e\ID
					e\room\NPC[i]\NPCEventID = i
				EndIf
			Next
		Next
	EndIf
...
Function UpdateDimension1499()
	Local returned = True
	If QuickLoadPercent = -1 Or QuickLoadPercent = 100 Then returned = False
	If returned Then Return False
	...
	If PlayerRoom = e\room Then
		...
		If QuickLoadPercent = 100 Or QuickLoadPercent = -1
			...
			Update1499Sky()
			ShouldPlay = 18
			If EntityY(e\NearObject)<800.0
				PositionEntity e\NearObject,EntityX(e\NearObject),800.5,EntityZ(e\NearObject),True
				ResetEntity e\NearObject
			EndIf
			...
			;If Abs(EntityX(e\NearObject)-(e\room\x-56.0*RoomScale))<2160.0*RoomScale Then
			;	If Abs(EntityZ(e\NearObject)-(e\room\z+2287.0*RoomScale))<1408.0*RoomScale Then
			;		ShouldPlay = 66
			;	EndIf
			;EndIf
...
End Function
Function UpdateEnding(e.Events)
	If e = exit1event Then
		;For e.Events = Each Events
		...
		If e\room\Objects[25] = 0 Then
			...
			e\room\Objects[25] = LoadMesh_Strict("GFX\map\exit1terrain.b3d", e\room\obj)
			ScaleEntity e\room\Objects[25],RoomScale,RoomScale,RoomScale,True
			RotateEntity e\room\Objects[25],0,e\room\angle,0,True
			PositionEntity(e\room\Objects[25], EntityX(pvt), EntityY(pvt), EntityZ(pvt), True)
		...
		Else
			...
			If e\EventState < 2.0 And SelectedEnding = "" Then 
				If e\room\NPC[0]\State = 2 Then
					If PlayerRoom = e\room Then ShouldPlay = 6
				Else
					...
					If PlayerRoom = e\room Then ShouldPlay = 5
				EndIf
				
				If EntityDistance(e\NearObject, e\room\Objects[10])<320*RoomScale Then
					e\EventState = 2.0
					e\room\RoomDoors[2]\open = False
					...
					PlayAnnouncement("SFX\Ending\GateB\682Battle.ogg", False, True)
				EndIf								
			Else
				If PlayerRoom = e\room Then ShouldPlay = 6
				e\EventState=e\EventState+FPSfactor
				...
				Else
					If SelectedEnding = "" Then
						...
						Else
							...
							;e\SoundCHN = PlaySound_Strict(e\Sound)
							PlayAnnouncement("SFX\Ending\GateB\AlphaWarheadsFail.ogg", False, True)
							...
							For n.NPCs = Each NPCs
								If n\NPCtype = NPCtypeMTF Then
									...
									n\State = 3
									n\State2 = 10
									n\EnemyX = EntityX(e\NearObject)
									n\EnemyY = EntityY(e\NearObject)
									n\EnemyZ = EntityZ(e\NearObject)
								EndIf
							Next
					...
					Else
						If SelectedEnding = "B3" Then
							...
							If e\EventState3 = 0.0
								For n.NPCs = Each NPCs
									If n\NPCtype = NPCtypeMTF
										If n\State = 5
											n\State = 3
											n\PathStatus = FindPath(n, EntityX(e\NearObject),EntityY(e\NearObject),EntityZ(e\NearObject))
											n\PathTimer = 70*Rand(15,20)
											n\LastSeen = 70*300
										EndIf
										If EntityDistance(n\Collider,e\NearObject)<3.0
											n\State = 5
											n\PathStatus = 0
											n\PathTimer = 0
											n\CurrSpeed = 0
							...
							For n.NPCs = Each NPCs
								If n\NPCtype = NPCtypeMTF
									If n\State = 5 And EntityDistance(n\Collider,e\NearObject)<3.0
										If e\EventState3 = 0.0
			...
			If e\EventState > 26.5*70 Then
				If e\room\Objects[12] = 0 Then
					...
					temp = (Min(((EntityDistance(e\room\NPC[3]\Collider,e\NearObject)/RoomScale)-3000.0)/4,1000)+12192.0)*RoomScale
		...
		;dist = Max(Min(EntityDistance(e\NearObject, e\room\objects[3])/10000.0,1.0),0.0)
		...
		If PlayerRoom = e\room And EntityY(Collider)>1040.0*RoomScale Then
			...
			SecondaryLightOn = True
			ShowEntity Sky
		Else If PlayerRoom\RoomTemplate\Name <> "gatea" Then 
			ShowEntity Fog
			AmbientLight Brightness, Brightness, Brightness
			CameraFogRange(Camera, CameraFogNear, CameraFogFar)
			CameraFogMode(Camera, 1)
		...
		If (e\room\NPC[1]\State <> 1) Then
			If ((EntityDistance(e\room\NPC[1]\Collider,e\NearObject) < 15.0) Or EntityVisible(e\room\NPC[0]\Collider,e\NearObject)) Then
				e\room\NPC[1]\State = 1
		...
		If (EntityDistance(e\room\NPC[1]\Collider,e\NearObject) < 8.9) Or (EntityDistance(e\room\Objects[5],e\NearObject) < 16.9) Then
			e\room\NPC[1]\State3 = 0
		Else
			e\room\NPC[1]\State3 = 1
		EndIf
		ShowEntity e\room\obj
	Else If e = GateAEvent Then
		e\StaticEvent = False
		ShowEntity e\room\obj
		...
		Else
			...
			If PlayerRoom = e\room Then
				...
				SecondaryLightOn = True
				ShowEntity Sky
			Else If PlayerRoom\RoomTemplate\Name <> "exit1" Then
				ShowEntity Fog
				AmbientLight Brightness, Brightness, Brightness
				CameraFogRange(Camera, CameraFogNear, CameraFogFar)
				CameraFogMode(Camera, 1)
			...
			If e\EventState=>350 Then
				If Contained106=False Then
					If e\EventState-FPSfactor < 350
						...
						PositionEntity (Curr106\Collider, EntityX(e\room\Objects[3],True),EntityY(e\NearObject)-50.0,EntityZ(e\room\Objects[3],True),True)
						PositionEntity (Curr106\obj, EntityX(e\room\Objects[3],True),EntityY(e\NearObject)-50.0,EntityZ(e\room\Objects[3],True),True)
					...
					If e\EventState3 = 0.0 Then 
						If Abs(EntityY(e\NearObject)-EntityY(e\room\Objects[11],True))<1.0 Then
							If Distance(EntityX(e\NearObject),EntityZ(e\NearObject),EntityX(e\room\Objects[11],True),EntityZ(e\room\Objects[11],True)) < 12.0 Then
								Curr106\State = 100000
								HideEntity Curr106\obj
								...
								For i = 5 To 8
									...
									e\room\NPC[i]\PathStatus = FindPath(e\room\NPC[i], EntityX(e\NearObject),EntityY(e\NearObject)+0.2,EntityZ(e\NearObject))
					...
					ElseIf e\EventState3 = 1.0
						...
						For i = 5 To 8
							If EntityDistance(e\room\NPC[i]\Collider,e\NearObject)> 4.0 Then
								e\room\NPC[i]\State = 3
							Else
								e\room\NPC[i]\State = 1
							EndIf
						...
						If Abs(EntityY(e\NearObject)-EntityY(e\room\Objects[11],True))<1.0 Then
							If Distance(EntityX(e\NearObject),EntityZ(e\NearObject),EntityX(e\room\Objects[11],True),EntityZ(e\room\Objects[11],True)) < 7.0 Then
								...
								p\speed = 0.25
								p\A = 0.5
								PointEntity p\pvt, e\NearObject
					...
					Else
						e\EventState3=e\EventState3+FPSfactor
						PointEntity e\room\Objects[12], e\NearObject
						...
						If KillTimer = 0 Then 
							...
							dist = EntityDistance(e\NearObject,e\room\Objects[11])
							If dist < 6.5 Then
								PositionEntity(e\NearObject, CurveValue(EntityX(e\room\Objects[11],True),EntityX(e\NearObject),dist*80),EntityY(e\NearObject),CurveValue(EntityZ(e\room\Objects[0],True),EntityZ(e\NearObject),dist*80))
							EndIf
						EndIf
				...
				Else ;contained106 = true
					...
					If e\EventState2 = 0 Then
						...
						For i = 5 To 8
							...
							e\room\NPC[i]\PathStatus = FindPath(e\room\NPC[i], EntityX(e\room\obj)-1.0+2.0*(i Mod 2),EntityY(e\NearObject)+0.2,EntityZ(e\room\obj)-2.0*(i Mod 2))
					...
					Else
						...
						For i = 5 To 8
							If e\room\NPC[i]\State = 5
								e\room\NPC[i]\EnemyX = EntityX(e\NearObject)
								e\room\NPC[i]\EnemyY = EntityY(e\NearObject)
								e\room\NPC[i]\EnemyZ = EntityZ(e\NearObject)
							Else
								If EntityDistance(e\room\NPC[i]\Collider,e\NearObject)<6.0
									e\room\NPC[i]\State = 5
							...
							For i = 5 To 8
								If e\room\NPC[i]\State = 5 Then
									For temp = 5 To 8
										...
										e\room\NPC[temp]\EnemyX = EntityX(e\NearObject)
										e\room\NPC[temp]\EnemyY = EntityY(e\NearObject)
										e\room\NPC[temp]\EnemyZ = EntityZ(e\NearObject)
